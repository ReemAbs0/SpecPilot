    ...
    >
      ...
      <div className="grid grid-cols-[160px_1fr] gap-6 p-6">
        ...
        <div className="space-y-4">
          <div className="flex h-9 items-center rounded-lg bg-brand-50 px-3">
            <div className="h-2.5 w-40 rounded bg-brand-100" />
          </div>
          <div className="space-y-2 rounded-lg bg-surface-muted p-4">
            <div className="h-3 w-full rounded bg-brand-100/70" />
    ...
    <section className="relative overflow-hidden">
      <div className="relative mx-auto max-w-5xl px-4 pb-12 pt-20 text-center sm:px-6">
        ...
        <h1 className="mx-auto max-w-3xl text-4xl font-bold leading-tight text-slate-900 sm:text-5xl">
          ...
          <span className="text-brand-600">Complete Specification</span>
        </h1>
