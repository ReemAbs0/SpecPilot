...
/** Light mode: the light screenshot steps forward, dark recedes. */
export const LightModeScene: React.FC = () => {
    ...
    <AbsoluteFill style={{ backgroundColor: "#05060F", fontFamily }}>
      <Interactive.Div
        ...
        style={{
          ...
          height: 780,
          background:
            "radial-gradient(60% 70% at 28% 45%, rgba(129,140,248,0.30) 0%, rgba(5,6,15,0) 70%)",
      ...
      <SceneCaption
        index="07 / 08"
        title="Light Mode"
        subtitle="Bright, high-contrast surfaces for daylight work."
      />
    </AbsoluteFill>
  );
};
